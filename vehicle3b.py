...
pygame.display.set_caption("Vehicle 3b: The explorer (crossed Inhibitory)")
...
# Main Loop
vehicle = Vehicle3b(WIDTH//2, HEIGHT//2)
...
while running:
    ...
    screen.blit(font.render("b: CROSSED INHIBITORY (explorer)", True, (0,0,0)), (10, 30))
